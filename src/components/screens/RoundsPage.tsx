    ...
    <div>
      ...
      {sortedRounds.length === 0 ? (
        ...
        <div className="border-t border-border">
          {/* Column header */}
          <div className="hidden grid-cols-[3rem_1fr_1fr_8rem_2rem] items-center gap-6 border-b border-border px-2 py-3 sm:grid">
              ...
              return (
                <li key={round.id}>
                  <Link
                    ...
                    className="group grid grid-cols-[2.5rem_1fr_auto] items-center gap-4 py-5 transition-colors hover:bg-card sm:grid-cols-[3rem_1fr_1fr_8rem_2rem] sm:gap-6 sm:px-2"
                  >
